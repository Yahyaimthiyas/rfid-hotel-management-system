...
|------|-------|------|----------------|
| **Yahya Imthiyas S** | `yahyaimthiyass.23cse@kongu.edu` | **Lead Developer & Project Manager & Hardware Specialist** | Full-stack Development, ESP32 Integration, System Architecture |
| **Vijaypriyan S** | `vijaypriyans.23cse@kongu.edu` | **Frontend Developer & UI/UX Designer** | React/Next.js, TypeScript, UI Design |
| **Shabharish P** | `shabharishp.23cse@kongu.edu` | **Backend Developer** | Node.js, MongoDB|
...
### **Project Duration**: 2 months (September 2025 - October 2025)
...
- ✅ **8 hotels** pre-configured with demo data
